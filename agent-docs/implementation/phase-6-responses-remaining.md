# Phase 6 — Responses Provider & Remaining Providers
...
### 6.1 Responses provider (`src/provider/responses.rs`)
...
Each is a thin struct following the Phase 4 pattern:

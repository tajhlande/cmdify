# Phase 7 — Gemini, OpenAI, Anthropic Providers
...
### 7.1 OpenAI provider (`src/provider/openai.rs`)
...
### 7.2 Anthropic provider (`src/provider/anthropic.rs`)
...
### 7.3 Gemini provider (`src/provider/gemini.rs`)
